...
public class LinkedListIndexedCollection implements List {
	 ...
	 *
	 */
	private static class LocalElementsGetter implements ElementsGetter {	
		...
		/**
		 * Current ListNode with value and references to previous and next ListNode in the Collection
		 */
		 ...
		 *                          to the Collection
		 */
		public LocalElementsGetter(int size, ListNode current, long modificationCount) {
		...
		public boolean hasNextElement() {
			...
			if(numberOfCalls==size) return false;
			return true;
		}
		 ...
		 * Collection
		 * 
		 * @throws NoSuchElementException() if the Collection is empty or all elements were already
		 * given to the user
		 * 
		 * @throws ConcurrentModificationException() if changes were made to the
		 *                                           Collection since Object
	...
	/**
	 * Public method that creates ElementsGetter using local class LocalElementsGetter. 
	 * 
	 * @return ElementsGetter
	 */
	public ElementsGetter createElementsGetter() {
		ElementsGetter newElementsGetter= new LocalElementsGetter(size, first, modificationCount);
