...
public class ArrayIndexedCollection implements List {
	...
	private static class LocalElementsGetter implements ElementsGetter {
		 ...
		 *                          to the Collection
		 */
		public LocalElementsGetter(int size, Object[] elements, long modificationCount) {
		...
		public Object getNextElement() {
			...
			if (numberOfCalls == size) {
				...
				Object send = current[numberOfCalls];
				numberOfCalls++;
				return send;
			}
		}
	...
	public ElementsGetter createElementsGetter() {
		LocalElementsGetter newElementsGetter = new LocalElementsGetter(size, elements, modificationCount);
