 ...
 * 
 * This class creates image that rotates in 3D space so user sees this scene from different angles
 * @author antonija
 *
 */
public class RayCasterParallel2 {
	...
	/**
	 * This method returns IRayTracerAnimator that creates animation for this example scene in 3D space.
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		...
		return new IRayTracerProducer() {
			...
			public void produce(Point3D eye, Point3D view, Point3D viewUp, double horizontal, double vertical,
				...
				pool.invoke(new PosaoIzracuna(eye, width, height, 0, height - 1, zAxis, yAxis, xAxis, horizontal,
						vertical, red, green, blue, screenCorner, scene, 0, cancel));
				pool.shutdown();
